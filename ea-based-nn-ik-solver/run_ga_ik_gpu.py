...
def fitness_func(ga_instance, solution, sol_idx):
    global data_inputs, data_outputs, torch_ga, model, loss_function, device
...
def callback_generation(ga_instance):
    global test_data_inputs, test_data_outputs, torch_ga, model, loss_function, test_error_function, arg_savingstep, device
