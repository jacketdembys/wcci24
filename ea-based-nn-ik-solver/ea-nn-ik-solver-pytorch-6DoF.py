...
if __name__ == '__main__':
    ...
    data = pd.read_csv('data_'+robot_choice+'_'+str(int(dataset_samples))+'_qlim_scale_'+str(int(scale))+'.csv')
    ...
    for experiment_number in range(experiments):
        ...
        ## train and validate
        # load the dataset
        train_data_loader, test_data_loader, X_test, y_test, X_train, y_train = load_dataset(data_a, n_DoF, batch_size, robot_choice)
